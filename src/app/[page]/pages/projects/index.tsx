...
export default function Projects() {
    const categorizedProjects = useAtomValue(categorizedProjectsAtom);
            ...
            {categorizedProjects[category].map(project => {
                ...
                return <Grid size={1} key={project.name} sx={{
                    ...
                    <Card sx={{
                        ...
                        {"cover" in project && project.cover && <CardMedia
                            component="img"
                            alt={`${project.name}的封面`}
                            height={cardWidth / project.cover.width * project.cover.height}
